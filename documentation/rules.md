...
| [`core-package-rules.md`](rules/core-package-rules.md) | Changing Python domain entities, structures, errors, events, interfaces, use cases, or module boundaries. | `apps/server/src/shifu/**/core/**`, `apps/server/src/shifu/fakers/**` |
